...
class TestTokenIdentity:
    ...
    def test_run_compute_outputs():
        ...
        source_layers = range(ti1._patchscope.n_layers_source)
        ti1.run(source_layers)

        ti2 = TokenIdentity("The quick brown fox jumps over the lazy", device="cpu")

        source_layers = range(ti2._patchscope.n_layers_source)
        ...
        for i, arg in enumerate(mock_nextloop.call_args_list):
            assert (arg[0][0][0] == ti1.outputs[i]).all()
